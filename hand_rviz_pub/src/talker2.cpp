...
int main(int argc, char **argv){
  ...
  while (ros::ok()){
    ...
    // adjust the angle of the fingers in the JointState message. WORK IN PROGRESS
    ...
    // adjust the values of the force sensors in the Markers. WORK IN PROGRESS
    ...
    chatter_pub2.publish(markerMsgs);

    // TO BE REMOVED. change the angle of joints
    if(dir){
